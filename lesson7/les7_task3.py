...
class Cell:
    ...
    def __str__(self):
        return '*' * self.cells_count if self.cells_count > 0 else 'клеток нет'

    def __add__(self, other):
        return Cell(self.cells_count + other.cells_count)

    def __sub__(self, other):
        return Cell(self.cells_count - other.cells_count if self.cells_count - other.cells_count > 0 else 0)
    ...
    def make_order(self, cell_in_row):
        string = '\n'.join(['*'*cell_in_row for i in range(self.cells_count // cell_in_row)]) + '\n' + \
                 '*'*(self.cells_count%cell_in_row)
        return string
